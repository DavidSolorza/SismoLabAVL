...
Original file is located at
    https://colab.research.google.com/drive/1xHUyjk2D6DloAionMxvXTFlcjBWJDCGF

# Árbol BST

Árbol binario de búsqueda que nos sirva para almacenar información ordenada con el fin de optimizar la búsqueda de elementos.

Se rige por 3 normas:
1. No se permiten valores repetidos.
2. EL valor mayor va por la derecha.
3. El valor menor va por la izquierda.
