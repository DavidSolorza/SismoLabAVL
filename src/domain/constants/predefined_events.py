...
Alineado rigurosamente con las Secciones 3 y 4 de la especificación técnica oficial:
- Plano cartesiano [0.0, 1000.0] km en ambos ejes (x, y).
- Profundidad H <= 700.0 km.
- Reglas de Prioridad P obligatorias:
...
PREDEFINED_EVENTS: List[Dict[str, Any]] = [
    # =========================================================================
    # BLOQUE 1: PRIORIDAD 3 (ALTA) - EVENTOS CRÍTICOS Y EMERGENCIA
    # =========================================================================
    {
        "id": 1010,
    ...
    },
    {
        ...
        "descripcion": "Evento de zona de subducción con alta liberación de energía. M=7.2 >= 6.0 -> Prioridad 3 (Alta).",
        "magnitud": 7.2,
        "profundidad": 25.0,
        "x": 120.0,
        "y": 180.0,
    ...
    {
        "id": 1012,
        "nombre": "Terremoto de Popayán (1983) - Falla Malvazá/Micay",
        "descripcion": "Superficial en zona densamente poblada. M=5.5 >= 4.5, H=15.0 <= 30.0 km, Urbana -> Prioridad 3 (Alta).",
        "magnitud": 5.5,
        "profundidad": 15.0,
        "x": 220.0,
        "y": 160.0,
    ...
    },
    {
        ...
        "descripcion": "Foco superficial bajo área urbana. M=4.8 >= 4.5, H=15.0 <= 30.0 km, Urbana -> Prioridad 3 (Alta).",
        "magnitud": 4.8,
        "profundidad": 15.0,
        "x": 380.0,
        "y": 520.0,
    ...
    },
    {
        ...
        "descripcion": "Actividad sismotectónica superficial en cabecera urbana. M=5.0 >= 4.5, H=12.0 <= 30.0 km, Urbana -> Prioridad 3 (Alta).",
        "magnitud": 5.0,
        "profundidad": 12.0,
        "x": 310.0,
        "y": 420.0,
    ...
    # =========================================================================
    {
        ...
        "descripcion": "Sismo intermedio/profundo. M=5.4 >= 4.5, pero H=150.0 > 30.0 km -> Prioridad 2 (Media).",
        "magnitud": 5.4,
        "profundidad": 150.0,
        "x": 650.0,
        "y": 780.0,
